  ...
  (function (_Component) {
    ...
    function WaveformContainer(props) {
      ...
      _this = (0, _possibleConstructorReturn2['default'])(
        this,
        (0, _getPrototypeOf2['default'])(WaveformContainer).call(this, props)
      );
                    ...
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        (_this$state = this.state),
                          ...
                          (initStructure = _this$state.initStructure),
                          (streamLength = _this$state.streamLength);
                        _context.prev = 1;
                        _context.next = 4;
                        return apiUtils.headRequest(
                          baseURL,
                          masterFileID,
                          'waveform.json'
                        );
                      ...
                      case 4:
                        ...
                        peaksOptions.dataUri = ''
                          .concat(baseURL, '/master_files/')
                          .concat(masterFileID, '/waveform.json'); // Update redux-store flag for waveform file retrieval
        ...
        value: function handleError(error) {
          ...
          if (error.response !== undefined) {
            ...
            if (status == 404) {
              peaksOptions.dataUri = ''
                .concat(baseURL, '/master_files/')
                .concat(masterFileID, '/waveform.json?empty=true');
