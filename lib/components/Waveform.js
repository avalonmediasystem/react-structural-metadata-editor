...
exports.PureWaveform = undefined;
...
var _utah_phillips_one = require('../data/utah_phillips_one.mp3');

var _utah_phillips_one2 = _interopRequireDefault(_utah_phillips_one);
...
var Waveform = function (_Component) {
  ...
  function Waveform(props) {
    ...
    // Create `refs`
    _this.waveformContainer = _react2.default.createRef();
    _this.mediaPlayer = _react2.default.createRef();
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'audio',
            {
              ...
              src: _utah_phillips_one2.default,
              type: 'audio/mp3',
...
// To use in the app
exports.default = (0, _reactRedux.connect)(mapStateToProps)(Waveform);