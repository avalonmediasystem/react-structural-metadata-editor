...
import { getExistingFormValues, getValidationBeginState, getValidationEndState, getValidationTitleState, isTitleValid, validTimespans } from '../services/form-helper';
...
var waveformUtils = new WaveformDataUtils();
...
var TimespanInlineForm = function (_Component) {
  ...
  TimespanInlineForm.prototype.componentDidMount = function componentDidMount() {
    ...
    this.setState(getExistingFormValues(item.id, this.tempSmData, peaksInstance.peaks));
  ...
  TimespanInlineForm.prototype.formIsValid = function formIsValid() {
    ...
    var timesValidResponse = validTimespans(beginTime, endTime, this.allSpans, this.props.peaksInstance.peaks);
