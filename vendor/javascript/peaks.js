 ...
 *
 * Peaks.js uses the HTML canvas element to display the waveform at
 * different zoom levels, and has configuration options to allow you
 * to customize the waveform views. Peaks.js allows users to interact
 * with the waveform views, including zooming and scrolling, and
 * creating point or segment markers that denote content to be clipped
 * or for reference
 *
 * Copyright 2020 British Broadcasting Corporation
 * License: Creative Commons 3.0 Unported License
 *
 */
(function (f) {
  ...
  })()(
    {
      ...
      5: [
        function (_dereq_, module, exports) {
          ...
          var BaseLayer = (function (_super) {
            ...
            BaseLayer.prototype.remove = function () {
              ...
              if (
                _canvas &&
                _canvas.parentNode &&
                Util_1.Util._isInDocument(_canvas)
              ) {
            ...
            BaseLayer.prototype._applyTransform = function (
              shape,
              context,
              top
            ) {
          ...
          Factory_1.Factory.addGetterSetter(
            BaseLayer,
      ...
      6: [
        function (_dereq_, module, exports) {
          ...
          function getDevicePixelRatio() {
            ...
            _pixelRatio = (function () {
              var devicePixelRatio =
                  Global_1.Konva._global.devicePixelRatio || 1,
                backingStoreRatio =
          ...
          Factory_1.Factory.addGetterSetter(
            ...
            'pixelRatio',
            undefined,
            Validators_1.getNumberValidator()
          );
      ...
      7: [
        function (_dereq_, module, exports) {
          ...
          var Container = (function (_super) {
            ...
            Container.prototype._drawChildren = function (
              canvas,
              drawMethod,
              top,
              caching,
      ...
      8: [
        function (_dereq_, module, exports) {
          ...
          var Context = (function () {
            ...
            Context.prototype.createRadialGradient = function (
              a0,
              a1,
              a2,
              a3,
          ...
          var SceneContext = (function (_super) {
            ...
            SceneContext.prototype._fillPattern = function (shape) {
              var fillPatternX = shape.getFillPatternX(),
                ...
                fillPatternRotation = Global_1.Konva.getAngle(
                  shape.getFillPatternRotation()
                ),
              ...
              if (fillPatternOffsetX || fillPatternOffsetY) {
                this.translate(
                  -1 * fillPatternOffsetX,
                  -1 * fillPatternOffsetY
                );
              }
          ...
          exports.Factory = {
            ...
            addSetter: function (constructor, attr, validator, after) {
              ...
              if (!constructor.prototype[method]) {
                exports.Factory.overWriteSetter(
                  constructor,
                  attr,
                  validator,
                  after
            ...
            addComponentsGetterSetter: function (
              ...
              var basicValidator = Validators_1.getComponentValidator(
                components
              );
            ...
            addDeprecatedGetterSetter: function (
              constructor,
              attr,
              def,
              validator
            ...
            backCompat: function (constructor, methods) {
              Util_1.Util.each(methods, function (
                oldMethodName,
                newMethodName
              ) {
      ...
      11: [
        ...
        { './BaseLayer': 5, './Container': 7, './Global': 12, './Util': 20 },
      ],
      12: [
        function (_dereq_, module, exports) {
          (function (global) {
            ...
            exports.Konva = {
              ...
              UA: exports._parseUA(
                (exports.glob.navigator && exports.glob.navigator.userAgent) ||
                  ''
              ),
            ...
            exports._registerNode = function (NodeClass) {
              exports._NODES_REGISTRY[
                NodeClass.prototype.getClassName()
              ] = NodeClass;
      ...
      14: [
        function (_dereq_, module, exports) {
          ...
          Factory_1.Factory.addGetterSetter(
            ...
            'hitGraphEnabled',
            true,
            Validators_1.getBooleanValidator()
          );
      ...
      15: [
        function (_dereq_, module, exports) {
          ...
          var Node = (function () {
            ...
            Node.prototype._delegate = function (event, selector, handler) {
              ...
              this.on(event, function (evt) {
                var targets = evt.target.findAncestors(
                  selector,
                  true,
                  stopNode
                );
            ...
            Node.prototype.toObject = function () {
              ...
              for (key in attrs) {
                val = attrs[key];
                nonPlainObject =
                  Util_1.Util.isObject(val) &&
                  !Util_1.Util._isPlainObject(val) &&
                  !Util_1.Util._isArray(val);
                if (nonPlainObject) {
                  continue;
                }
            ...
            Node.prototype.findAncestors = function (
              selector,
              includeSelf,
              stopNode
            ) {
            ...
            Node.prototype.findAncestor = function (
              selector,
              includeSelf,
              stopNode
            ) {
            ...
            Node.prototype._toKonvaCanvas = function (config) {
              ...
              var stage = this.getStage(),
                ...
                canvas = new Canvas_1.SceneCanvas({
                  width:
                    config.width || box.width || (stage ? stage.width() : 0),
                  height:
                    config.height || box.height || (stage ? stage.height() : 0),
                  pixelRatio: pixelRatio,
                }),
            ...
            Node.prototype.toDataURL = function (config) {
              ...
              var url = this._toKonvaCanvas(config).toDataURL(
                mimeType,
                quality
              );
              if (config.callback) {
            ...
            Node.prototype._fireAndBubble = function (
              eventType,
              evt,
              compareShape
            ) {
            ...
            Node.prototype._listenDrag = function () {
              ...
              this.on('mousedown.konva touchstart.konva', function (evt) {
                ...
                var canDrag =
                  !shouldCheckButton ||
                  Global_1.Konva.dragButtons.indexOf(evt.evt['button']) >= 0;
                if (!canDrag) {
                  return;
                }
                if (this.isDragging()) {
          ...
          Factory_1.Factory.addGetterSetter(
            ...
            'globalCompositeOperation',
            'source-over',
            Validators_1.getStringValidator()
          );
          Factory_1.Factory.addGetterSetter(
            Node,
            'opacity',
          ...
          Factory_1.Factory.addGetterSetter(Node, 'filters', null, function (
            val
          ) {
            this._filterUpToDate = false;
            return val;
      ...
      16: [
        function (_dereq_, module, exports) {
          ...
          var SUPPORT_POINTER_EVENTS =
            Global_1.Konva._global['PointerEvent'] !== undefined;
        ...
        function (_dereq_, module, exports) {
          ...
          var Shape = (function (_super) {
            ...
            Shape.prototype.drawHitFromCache = function (alphaThreshold) {
              ...
              try {
                hitImageData = hitContext.getImageData(
                  0,
                  0,
                  hitWidth,
                  hitHeight
          ...
          Factory_1.Factory.addGetterSetter(
            ...
            'hitStrokeWidth',
            'auto',
            Validators_1.getNumberOrAutoValidator()
          );
          Factory_1.Factory.addGetterSetter(
            Shape,
            'strokeHitEnabled',
          ...
          Factory_1.Factory.addComponentsGetterSetter(
            Shape,
            'fillPatternOffset',
            ['x', 'y']
          );
        ...
        function (_dereq_, module, exports) {
          ...
          var Stage = (function (_super) {
            ...
            function Stage(config) {
              ...
              _this.on(
                'widthChange.konva heightChange.konva',
                _this._resizeDOM
              );
            ...
            Stage.prototype._mouseout = function (evt) {
              ...
              var eventsEnabled =
                !DragAndDrop_1.DD.isDragging || Global_1.Konva.hitOnDragEnabled;
            ...
            Stage.prototype._mousemove = function (evt) {
              ...
              if (eventsEnabled) {
                ...
                if (shape && shape.isListening()) {
                  var differentTarget =
                    !this.targetShape || this.targetShape !== shape;
                  if (eventsEnabled && differentTarget) {
                    if (this.targetShape) {
                      this.targetShape._fireAndBubble(
                        MOUSEOUT,
                        { evt: evt, pointerId: pointerId },
                        shape
                      );
                      this.targetShape._fireAndBubble(
                        MOUSELEAVE,
            ...
            Stage.prototype._touchmove = function (evt) {
              ...
              if (
                DragAndDrop_1.DD.isDragging &&
                DragAndDrop_1.DD.node.preventDefault() &&
                evt.cancelable
              ) {
                evt.preventDefault();
              }
            ...
            Stage.prototype.setPointersPositions = function (evt) {
              ...
              if (evt.touches !== undefined) {
                ...
                Util_1.Collection.prototype.each.call(evt.touches, function (
                  touch
                ) {
                  _this._pointerPositions.push({
                    ...
                    x:
                      ...
                      contentPosition.scaleX,
                    y:
                      (touch.clientY - contentPosition.top) /
                      contentPosition.scaleY,
                  });
                });
                Util_1.Collection.prototype.each.call(
                ...
                x =
                  (evt.clientX - contentPosition.left) / contentPosition.scaleX;
                y =
                  (evt.clientY - contentPosition.top) / contentPosition.scaleY;
                this.pointerPos = {
                  x: x,
                  y: y,
                };
      ...
      19: [
        function (_dereq_, module, exports) {
          ...
          var Tween = (function () {
            function Tween(config) {
              ...
              var layers =
                node.getLayer() ||
                (node instanceof Global_1.Konva['Stage']
                  ? node.getLayers()
                  : null);
              if (!layers) {
                Util_1.Util.error(
              ...
              if (Util_1.Util._isArray(end)) {
                ...
                if (key === 'points' && end.length !== start.length) {
                  if (end.length > start.length) {
                    trueStart = start;
                    start = Util_1.Util._prepareArrayForTween(
                      start,
                      end,
                      node.closed()
                    );
                    ...
                    trueEnd = end;
                    end = Util_1.Util._prepareArrayForTween(
                      end,
                      start,
                      node.closed()
                    );
          ...
          exports.Easings = {
            ...
            BounceEaseInOut: function (t, b, c, d) {
              if (t < d / 2) {
                ...
                return (
                  exports.Easings.BounceEaseOut(t * 2 - d, 0, c, d) * 0.5 +
                  c * 0.5 +
                  b
                );
              }
        ...
        { './Animation': 4, './Global': 12, './Node': 15, './Util': 20 },
      ],
      20: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          var Transform = (function () {
            ...
            Transform.prototype.multiply = function (matrix) {
              ...
              var dx =
                this.m[0] * matrix.m[4] + this.m[2] * matrix.m[5] + this.m[4];
              var dy =
                this.m[1] * matrix.m[4] + this.m[3] * matrix.m[5] + this.m[5];
              this.m[0] = m11;
              this.m[1] = m12;
              this.m[2] = m21;
              this.m[3] = m22;
          ...
          exports.Util = {
            ...
            colorToRGBA: function (str) {
              str = str || 'black';
              return (
                exports.Util._namedColorToRBA(str) ||
            ...
            _expandPoints: function (p, tension) {
              var len = p.length,
                ...
                cp;
              for (n = 2; n < len - 2; n += 2) {
                cp = exports.Util._getControlPoints(
                  p[n - 2],
                  p[n - 1],
                  p[n],
                  p[n + 1],
            ...
            _getProjectionToLine: function (pt, line, isClosed) {
              ...
              line.forEach(function (p1, i) {
                ...
                var proj = exports.Util._getProjectionToSegment(
                  p1.x,
                  p1.y,
                  p2.x,
                  p2.y,
            ...
            _prepareArrayForTween: function (startArray, endArray, isClosed) {
              ...
              var newStart = [];
                ...
                var pr = exports.Util._getProjectionToLine(
                  point,
                  start,
                  isClosed
                );
            ...
            _prepareToStringify: function (obj) {
              ...
              for (var key in obj) {
                ...
                if (
                  ...
                  exports.Util._prepareToStringify(obj[key]) === null
                ) {
                  if (desc.configurable) {
                    delete obj[key];
                  } else {
      ...
      23: [
        function (_dereq_, module, exports) {
          ...
          exports.Konva = _CoreInternals_1.Konva.Util._assign(
            _CoreInternals_1.Konva,
            {
              Arc: Arc_1.Arc,
              Arrow: Arrow_1.Arrow,
        ...
        },
        {
          ...
          './filters/Emboss': 27,
          './filters/Enhance': 28,
          './filters/Grayscale': 29,
          './filters/HSL': 30,
          './filters/HSV': 31,
          './filters/Invert': 32,
          './filters/Kaleidoscope': 33,
          './filters/Mask': 34,
          './filters/Noise': 35,
          './filters/Pixelate': 36,
          './filters/Posterize': 37,
          './filters/RGB': 38,
          './filters/RGBA': 39,
          './filters/Sepia': 40,
          './filters/Solarize': 41,
          './filters/Threshold': 42,
          './shapes/Arc': 44,
          './shapes/Arrow': 45,
          './shapes/Circle': 46,
          './shapes/Ellipse': 47,
          ...
          './shapes/Path': 51,
          './shapes/Rect': 52,
          './shapes/RegularPolygon': 53,
          './shapes/Ring': 54,
          './shapes/Sprite': 55,
          './shapes/Star': 56,
          './shapes/Text': 57,
          './shapes/TextPath': 58,
          './shapes/Transformer': 59,
          './shapes/Wedge': 60,
        },
      ],
      24: [
        ...
        { '../Factory': 10, '../Node': 15, '../Validators': 21 },
      ],
      25: [
        function (_dereq_, module, exports) {
          'use strict';
      ...
      27: [
        ...
        { '../Factory': 10, '../Node': 15, '../Util': 20, '../Validators': 21 },
      ],
      28: [
        function (_dereq_, module, exports) {
          'use strict';
          ...
          var FromPolar = function (src, dst, opt) {
            ...
            for (x = 0; x < xSize; x += 1) {
              for (y = 0; y < ySize; y += 1) {
                ...
                theta =
                  ((Math.atan2(dy, dx) * 180) / Math.PI + 360 + phaseShift) %
                  360;
      ...
      38: [
        function (_dereq_, module, exports) {
          ...
          Factory_1.Factory.addGetterSetter(Node_1.Node, 'red', 0, function (
            val
          ) {
            this._filterUpToDate = false;
            if (val > 255) {
          ...
          Factory_1.Factory.addGetterSetter(Node_1.Node, 'green', 0, function (
            val
          ) {
            this._filterUpToDate = false;
            if (val > 255) {
      ...
      39: [
        function (_dereq_, module, exports) {
          ...
          Factory_1.Factory.addGetterSetter(Node_1.Node, 'alpha', 1, function (
            val
          ) {
            this._filterUpToDate = false;
            if (val > 1) {
        ...
        function (_dereq_, module, exports) {
          ...
          var Arrow = (function (_super) {
            ...
            Arrow.prototype._sceneFunc = function (ctx) {
              ...
              if (fromTension) {
                dx =
                  points[n - 2] - (tp[tp.length - 2] + tp[tp.length - 4]) / 2;
                dy =
                  points[n - 1] - (tp[tp.length - 1] + tp[tp.length - 3]) / 2;
              } else {
      ...
      50: [
        function (_dereq_, module, exports) {
          ...
          var Line = (function (_super) {
            ...
            Line.prototype._getTensionPointsClosed = function () {
              var p = this.points(),
                len = p.length,
                tension = this.tension(),
                firstControlPoints = Util_1.Util._getControlPoints(
                  p[len - 2],
                  p[len - 1],
                  p[0],
                  p[1],
                ...
                lastControlPoints = Util_1.Util._getControlPoints(
                  p[len - 4],
                  p[len - 3],
                  p[len - 2],
                  p[len - 1],
          ...
          Factory_1.Factory.addGetterSetter(
            ...
            'points',
            [],
            Validators_1.getNumberArrayValidator()
          );
      ...
      51: [
          ...
          var Path = (function (_super) {
            ...
            Path.getPointOnLine = function (
              ...
              if (P2x === P1x) {
                ...
                var u =
                  (fromX - P1x) * (P2x - P1x) + (fromY - P1y) * (P2y - P1y);
                u = u / (len * len);
                ix = P1x + u * (P2x - P1x);
                iy = P1y + u * (P2y - P1y);
            ...
            Path.getPointOnCubicBezier = function (
              pct,
              P1x,
              P1y,
              P2x,
            ...
            Path.getPointOnQuadraticBezier = function (
              pct,
              P1x,
              P1y,
              P2x,
            ...
            Path.getPointOnEllipticalArc = function (
              cx,
              cy,
              rx,
              ry,
            ...
            Path.convertEndpointToCenterParameterization = function (
              ...
              var cyp = (f * -ry * xp) / rx;
              var cx =
                (x1 + x2) / 2.0 + Math.cos(psi) * cxp - Math.sin(psi) * cyp;
              var cy =
                (y1 + y2) / 2.0 + Math.sin(psi) * cxp + Math.cos(psi) * cyp;
              var vMag = function (v) {
              ...
              var vAngle = function (u, v) {
                return (
                  (u[0] * v[1] < u[1] * v[0] ? -1 : 1) * Math.acos(vRatio(u, v))
                );
              };
        ...
        { '../Factory': 10, '../Global': 12, '../Shape': 17, '../Util': 20 },
      ],
      52: [
        function (_dereq_, module, exports) {
          'use strict';
      ...
      57: [
        function (_dereq_, module, exports) {
          ...
          function getDummyContext() {
            ...
            dummyContext = Util_1.Util.createCanvasElement().getContext(
              CONTEXT_2D
            );
            return dummyContext;
          }
          ...
          var Text = (function (_super) {
            ...
            function Text(config) {
              ...
              for (var n = 0; n < attrChangeListLen; n++) {
                _this.on(
                  ATTR_CHANGE_LIST[n] + CHANGE_KONVA,
                  _this._setTextData
                );
              }
              _this._setTextData();
            ...
            Text.prototype._sceneFunc = function (context) {
              ...
              if (verticalAlign === MIDDLE) {
                alignY =
                  (this.getHeight() - textArrLen * lineHeightPx - padding * 2) /
                  2;
              ...
              for (n = 0; n < textArrLen; n++) {
                ...
                if (letterSpacing !== 0 || align === JUSTIFY) {
                  ...
                  for (var li = 0; li < text.length; li++) {
                    ...
                    context.fillStrokeShape(this);
                    lineTranslateX +=
                      Math.round(this.measureSize(letter).width) +
                      letterSpacing;
                  }
                } else {
                  this._partialTextX = lineTranslateX;
                  ...
                  while (line.length > 0) {
                    ...
                    while (low < high) {
                      var mid = (low + high) >>> 1,
                        ...
                        substrWidth =
                          this._getTextWidth(substr) + additionalWidth;
                    ...
                    if (match) {
                      if (wrapAtWord) {
                        ...
                        var nextIsSpaceOrDash =
                          nextChar === SPACE || nextChar === DASH;
          ...
          Factory_1.Factory.overWriteSetter(
            Text,
            'width',
            Validators_1.getNumberOrAutoValidator()
          );
          ...
          var TextPath = (function (_super) {
            ...
            TextPath.prototype._setTextData = function () {
              ...
              var textFullWidth = Math.max(
                this.textWidth +
                  ((this.attrs.text || '').length - 1) * letterSpacing,
                0
              );
              this.glyphInfo = [];
              var fullPathWidth = 0;
                  ...
                  switch (pathCmd.command) {
                    ...
                    case 'A':
                      ...
                      if (currentT === 0) {
                        ...
                        currentT +=
                          ((Math.PI / 180.0) * dTheta) / Math.abs(dTheta);
                      } else {
                        currentT -=
                          ((Math.PI / 360.0) * dTheta) / Math.abs(dTheta);
                      }
                      if (
                      ...
                      p1 = Path_1.Path.getPointOnEllipticalArc(
                        pathCmd.points[0],
                        pathCmd.points[1],
                        pathCmd.points[2],
                        pathCmd.points[3],
                    ...
                    case 'C':
                      ...
                      p1 = Path_1.Path.getPointOnCubicBezier(
                        currentT,
                        pathCmd.start.x,
                        pathCmd.start.y,
                        pathCmd.points[0],
                    ...
                    case 'Q':
                      ...
                      p1 = Path_1.Path.getPointOnQuadraticBezier(
                        currentT,
                        pathCmd.start.x,
                        pathCmd.start.y,
                        pathCmd.points[0],
              ...
              var testChar = 'C';
              var glyphWidth =
                that._getTextSize(testChar).width + letterSpacing;
              ...
              for (var i = 0; i < charArr.length; i++) {
                ...
                if (kerningFunc) {
                  try {
                    kern =
                      kerningFunc(charArr[i - 1], charArr[i]) * this.fontSize();
                  } catch (e) {
                    kern = 0;
                  }
                }
                ...
                p1.x += kern;
                this.textWidth += kern;
                var midpoint = Path_1.Path.getPointOnLine(
                  kern + width / 2.0,
                  p0.x,
                  p0.y,
                  p1.x,
      ...
      59: [
        function (_dereq_, module, exports) {
          ...
          function getCursor(anchorName, rad, isMirrored) {
            ...
            if (
              Util_1.Util._inRange(angle, 315 + 22.5, 360) ||
              Util_1.Util._inRange(angle, 0, 22.5)
            ) {
              return 'ns-resize';
          ...
          var Transformer = (function (_super) {
            ...
            Transformer.prototype.setNode = function (node) {
              ...
              node.on(
                'xChange.' + EVENTS_NAME + ' yChange.' + EVENTS_NAME,
                function () {
            ...
            Transformer.prototype.__getNodeRect = function () {
              ...
              return {
                x:
                  node.x() + dx * Math.cos(rotation) + dy * Math.sin(-rotation),
              ...
              var back = new Shape_1.Shape({
                ...
                sceneFunc: function (ctx) {
                  ...
                  if (tr.rotateEnabled()) {
                    ctx.lineTo(
                      this.width() / 2,
                      -tr.rotateAnchorOffset() *
                        Util_1.Util._sign(this.height()) -
                        padding
                    );
                  }
                  ctx.fillStrokeShape(this);
            ...
            Transformer.prototype._handleMouseMove = function (e) {
              ...
              if (this._movingAnchorName === 'top-left') {
                ...
                var newRotation =
                  Util_1.Util._radToDeg(rot) + Util_1.Util._radToDeg(dAlpha);
                ...
                for (var i = 0; i < snaps.length; i++) {
                  ...
                  var dif =
                    Math.abs(angle - Util_1.Util._degToRad(newRotation)) %
                    (Math.PI * 2);
                  if (dif < offset) {
                ...
                this._fitNodeInto(
                  {
                    rotation: Global_1.Konva.angleDeg
                      ? newRotation
                      : Util_1.Util._degToRad(newRotation),
                    x:
                      attrs.x +
              ...
              if (centeredScaling) {
                ...
                var bottomOffsetY =
                  this.getHeight() - bottomRight.y() + padding;
                bottomRight.move({
                  x: -topOffsetX,
                  y: -topOffsetY,
                });
            ...
            Transformer.prototype._fitNodeInto = function (newAttrs, evt) {
              ...
              var padding = this.padding();
              var scaleX = pure.width
                ? (newAttrs.width - padding * 2) / pure.width
                : 1;
              ...
              this.getNode().setAttrs({
                ...
                y:
                  newAttrs.y -
                  (dy * Math.cos(rotation) + dx * Math.sin(rotation)),
              });
            ...
            Transformer.prototype.update = function () {
              ...
              this.findOne('.top-left').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('top-left') >= 0,
              });
              this.findOne('.top-center').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('top-center') >= 0,
              });
              this.findOne('.top-right').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('top-right') >= 0,
              });
              this.findOne('.middle-left').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('middle-left') >= 0,
              });
              this.findOne('.middle-right').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('middle-right') >= 0,
              });
              this.findOne('.bottom-left').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('bottom-left') >= 0,
              });
              this.findOne('.bottom-center').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('bottom-center') >= 0,
              });
              this.findOne('.bottom-right').setAttrs({
                ...
                scale: invertedScale,
                visible:
                  resizeEnabled && enabledAnchors.indexOf('bottom-right') >= 0,
              });
              ...
              this.findOne('.rotater').setAttrs({
                x: width / 2,
                y:
                  scaledRotateAnchorOffset * Util_1.Util._sign(height) -
                  padding,
                scale: invertedScale,
          ...
          var Wedge = (function (_super) {
            ...
            Wedge.prototype._sceneFunc = function (context) {
              ...
              context.arc(
                ...
                this.radius(),
                0,
                Global_1.Konva.getAngle(this.angle()),
                this.clockwise()
              );
              context.lineTo(0, 0);
              context.closePath();
      ...
      62: [
        function (_dereq_, module, exports) {
          ...
          WaveformDataArrayBufferAdapter.isCompatible = function isCompatible(
            data
          ) {
            const isCompatible =
          ...
          WaveformDataArrayBufferAdapter.prototype = {
            ...
            concatBuffers: function () {
              ...
              var bufferCollection = [this]
                .concat(otherAdapters)
                .map(function (w) {
              ...
              for (i = 0; i < bufferCollection.length; i++) {
                buffer = bufferCollection[i];
                dataOfTotalBuffer.set(
                  new Uint8Array(buffer, headerSize),
                  offset
                );
          ...
          function getAudioDecoder(options, callback) {
            return function onAudioDecoded(audio_buffer) {
              var worker = new InlineWorker(function () {
                ...
                function calculateWaveformDataLength(
                  audio_sample_count,
                  scale
                ) {
                  var data_length = Math.floor(audio_sample_count / scale);

                  var samples_remaining =
                    audio_sample_count - data_length * scale;
                ...
                this.addEventListener('message', function (evt) {
                  ...
                  var data_length = calculateWaveformDataLength(
                    audio_buffer.length,
                    scale
                  );
                  var total_size =
                    header_size + data_length * 2 * output_channels;
                  ...
                  for (i = 0; i < buffer_length; i++) {
                    ...
                    if (output_channels === 1) {
                      ...
                      sample = Math.floor(
                        (INT8_MAX * sample * amplitude_scale) / channels.length
                      );
                      ...
                      for (channel = 0; channel < output_channels; ++channel) {
                        sample = Math.floor(
                          INT8_MAX * channels[channel][i] * amplitude_scale
                        );
              ...
              for (
                ...
                audio_buffer_obj.channels[
                  channel
                ] = audio_buffer.getChannelData(channel);
              }
      ...
      65: [
        function (_dereq_, module, exports) {
          ...
          function getOptions(options) {
            if (
              Object.prototype.hasOwnProperty.call(options, 'scale_adjuster')
            ) {
              throw new Error(
                "Please rename the 'scale_adjuster' option to 'amplitude_scale'"
              );
            }
            ...
            var opts = {
              ...
              split_channels:
                options.split_channels || defaultOptions.split_channels,
            };
      ...
      66: [
        function (_dereq_, module, exports) {
          ...
          function createFromArrayBuffer(
            audioContext,
            audioData,
            options,
            callback
          ...
          function createFromAudio(options, callback) {
            ...
            if (options.audio_context && options.array_buffer) {
              return createFromArrayBuffer(
                options.audio_context,
                options.array_buffer,
                opts,
                callback
              );
            } else if (options.audio_buffer) {
              return createFromAudioBuffer(
              ...
              throw new TypeError(
                'Please pass either an AudioContext and ArrayBuffer, or an AudioBuffer object'
              );
            }
          }
      ...
      68: [
        function (_dereq_, module, exports) {
          ...
          var WaveformDataArrayBufferAdapter = _dereq_(
          ...
          WaveformData.prototype = {
            ...
            resample: function (options) {
              ...
              options.input_index =
                typeof options.input_index === 'number'
                  ? options.input_index
                  : null;
              options.output_index =
                typeof options.output_index === 'number'
                  ? options.output_index
                  : null;
              options.scale =
              ...
              var is_partial_resampling =
                Boolean(options.input_index) || Boolean(options.output_index);

              if (options.input_index != null && options.input_index < 0) {
                throw new RangeError(
                  'options.input_index should be a positive integer value. [' +
                    options.input_index +
                    ']'
                );
              }
              ...
              if (options.output_index != null && options.output_index < 0) {
                throw new RangeError(
                  'options.output_index should be a positive integer value. [' +
                    options.output_index +
                    ']'
                );
              }
              ...
              if (options.width != null && options.width <= 0) {
                throw new RangeError(
                  'options.width should be a strictly positive integer value. [' +
                    options.width +
                    ']'
                );
              }
              ...
              if (options.scale != null && options.scale <= 0) {
                throw new RangeError(
                  'options.scale should be a strictly positive integer value. [' +
                    options.scale +
                    ']'
                );
              }
              ...
              if (!options.scale && !options.width) {
                throw new RangeError(
                  'You should provide either a resampling scale or a width in pixel the data should fit in.'
                );
              }

              var definedPartialOptionsCount = [
                'width',
                'scale',
                'output_index',
                'input_index',
              ...
              if (is_partial_resampling && definedPartialOptionsCount !== 4) {
                throw new Error(
                  'Some partial resampling options are missing. You provided ' +
                    definedPartialOptionsCount +
                    ' of them over 4.'
                );
              }
              ...
              var samples_per_pixel =
                options.scale ||
                Math.floor((this.duration * this.sample_rate) / options.width); // scale we want to reach
              ...
              while (input_index < input_buffer_size) {
                while (
                  Math.floor(sample_at_pixel(output_index) / scale) <=
                  input_index
                ) {
                  if (output_index > 0) {
                    for (let channel = 0; channel < channels; ++channel) {
                ...
                if (
                  is_partial_resampling &&
                  output_data.length / channel_count >= options.width
                ) {
                  break;
                }
              }
            ...
            concat: function () {
              ...
              otherWaveforms.forEach(function (otherWaveform) {
                if (
                  ...
                  Object.getPrototypeOf(self._adapter) !==
                    Object.getPrototypeOf(otherWaveform._adapter) ||
              ...
              var combinedBuffer = this._adapter.concatBuffers.apply(
                this._adapter,
                otherAdapters
              );
      ...
      69: [
        ...
        { './lib/builders/webaudio': 66, './lib/core': 68 },
      ],
      70: [
        function (_dereq_, module, exports) {
          module.exports = (function (
            ...
            Peaks.init = function (opts, callback) {
              ...
              if (typeof instance.options.template === 'string') {
                ...
                throw new TypeError(
                  'Peaks.init(): The template option must be a valid HTML string or a DOM object'
                );
              }
              var zoomviewContainer = containers.zoomview || containers.zoom;
              if (
                !Utils.isHTMLElement(zoomviewContainer) &&
                !Utils.isHTMLElement(containers.overview)
              ) {
                throw new TypeError(
                  'Peaks.init(): The containers.zoomview and/or containers.overview options must be valid HTML elements'
                );
              }
              if (zoomviewContainer && zoomviewContainer.clientWidth <= 0) {
                throw new TypeError(
                  'Peaks.init(): Please ensure that the zoomview container is visible and has non-zero width'
                );
              }
              if (containers.overview && containers.overview.clientWidth <= 0) {
                throw new TypeError(
                  'Peaks.init(): Please ensure that the overview container is visible and has non-zero width'
                );
              }
              ...
              waveformBuilder.init(instance.options, function (
                err,
                waveformData
              ) {
                if (err) {
            ...
            Peaks.prototype._setOptions = function (opts) {
              opts.deprecationLogger =
                opts.deprecationLogger || console.log.bind(console);
              if (opts.audioElement) {
                opts.mediaElement = opts.audioElement;
                opts.deprecationLogger(
                  'Peaks.init(): The audioElement option is deprecated, please use mediaElement instead'
                );
              }
              if (opts.overviewHighlightRectangleColor) {
                opts.overviewHighlightColor =
                  opts.overviewHighlightRectangleColor;
                opts.deprecationLogger(
                  'overviewHighlightRectangleColor has been renamed overviewHighlightColor'
                );
              }
              ...
              if (!opts.container && !opts.containers) {
                throw new Error(
                  'Peaks.init(): Please specify either a container or containers option'
                );
              } else if (Boolean(opts.container) === Boolean(opts.containers)) {
                throw new Error(
                  'Peaks.init(): Please specify either a container or containers option, but not both'
                );
              }
              if (opts.template && opts.containers) {
                throw new Error(
                  'Peaks.init(): Please specify either a template or a containers option, but not both'
                );
              }
              if (opts.containers) {
                opts.template = null;
              ...
              if (!Array.isArray(this.options.zoomLevels)) {
                ...
                throw new Error(
                  'Peaks.init(): The zoomLevels array must not be empty'
                );
              } else {
              ...
              if (this.options.pointDblClickHandler) {
                opts.deprecationLogger(
                  'Peaks.init(): The pointDblClickHandler option is deprecated, please use the points.dblclick event instead'
                );
                this.on('points.dblclick', this.options.pointDblClickHandler);
              }
              if (this.options.pointDragEndHandler) {
                opts.deprecationLogger(
                  'Peaks.init(): The pointDragEndHandler option is deprecated, please use the points.dragend event instead'
                );
            ...
            Peaks.prototype.setSource = function (options, callback) {
              ...
              if (!options.mediaUrl) {
                callback(
                  new Error(
                    'peaks.setSource(): options must contain a mediaUrl'
                  )
                );
                return;
              }
            ...
            _dereq_('peaks/markers/waveform.points'),
            _dereq_('peaks/markers/waveform.segments'),
            _dereq_('peaks/player/player'),
            _dereq_('peaks/views/view-controller'),
            _dereq_('peaks/views/waveform.timecontroller'),
            _dereq_('peaks/views/waveform.zoomcontroller'),
            _dereq_('peaks/waveform/waveform-builder'),
            _dereq_('peaks/waveform/waveform.mixins'),
            _dereq_('peaks/waveform/waveform.utils'),
            _dereq_('peaks/player/player.keyboard'),
            _dereq_('peaks/cues/cue-emitter')
          );
        },
        {
          EventEmitter: 2,
          'colors.css': 1,
          'peaks/cues/cue-emitter': 71,
          'peaks/markers/waveform.points': 75,
          'peaks/markers/waveform.segments': 76,
          'peaks/player/player': 77,
          'peaks/player/player.keyboard': 78,
          'peaks/views/view-controller': 83,
          'peaks/views/waveform.timecontroller': 86,
          'peaks/views/waveform.zoomcontroller': 87,
          'peaks/waveform/waveform-builder': 89,
          'peaks/waveform/waveform.mixins': 91,
          'peaks/waveform/waveform.utils': 92,
        },
      ],
      71: [
        function (_dereq_, module, exports) {
          module.exports = (function (Cue) {
            ...
            CueEmitter.prototype._updateCues = function () {
              ...
              segments.forEach(function (segment) {
                ...
                self._cues.push(
                  new Cue(segment.endTime, Cue.SEGMENT_END, segment.id)
                );
              });
            ...
            CueEmitter.prototype.onTimeUpdate = function (time) {
              ...
              if (
                this._peaks.player.isPlaying() &&
                !this._peaks.player.isSeeking()
              ) {
            ...
            CueEmitter.prototype._updateActiveSegments = function (time) {
              ...
              for (var id in self._activeSegments) {
                if (
                  Object.prototype.hasOwnProperty.call(self._activeSegments, id)
                ) {
          ...
          module.exports = (function (Utils) {
            ...
            function validatePoint(time, labelText) {
              if (!Utils.isValidTime(time)) {
                throw new TypeError(
                  'peaks.points.add(): time should be a numeric value'
                );
              }
              if (time < 0) {
                throw new TypeError(
                  'peaks.points.add(): time should not be negative'
                );
              }
              if (Utils.isNullOrUndefined(labelText)) {
                ...
                throw new TypeError(
                  'peaks.points.add(): labelText must be a string'
                );
              }
            }
            ...
            Point.prototype.update = function (options) {
              var time = Object.prototype.hasOwnProperty.call(options, 'time')
                ? options.time
                : this.time;
              var labelText = Object.prototype.hasOwnProperty.call(
                options,
                'labelText'
              )
                ? options.labelText || ''
                : this.labelText;
              var color = Object.prototype.hasOwnProperty.call(options, 'color')
                ? options.color
                : this.color;
              var editable = Object.prototype.hasOwnProperty.call(
                options,
                'editable'
              )
                ? options.editable
        ...
        function (_dereq_, module, exports) {
          module.exports = (function (Utils) {
            ...
            function validateSegment(startTime, endTime, validationContext) {
              if (!Utils.isValidTime(startTime)) {
                throw new TypeError(
                  'peaks.segments.' +
                    validationContext +
                    ': startTime should be a valid number'
                );
              }
              if (!Utils.isValidTime(endTime)) {
                throw new TypeError(
                  'peaks.segments.' +
                    validationContext +
                    ': endTime should be a valid number'
                );
              }
              if (startTime < 0) {
                throw new RangeError(
                  'peaks.segments.' +
                    validationContext +
                    ': startTime should not be negative'
                );
              }
              if (endTime < 0) {
                throw new RangeError(
                  'peaks.segments.' +
                    validationContext +
                    ': endTime should not be negative'
                );
              }
            ...
            Segment.prototype.update = function (options) {
              var startTime = Object.prototype.hasOwnProperty.call(
                options,
                'startTime'
              )
                ? options.startTime
                : this.startTime;
              var endTime = Object.prototype.hasOwnProperty.call(
                options,
                'endTime'
              )
                ? options.endTime
        ...
        function (_dereq_, module, exports) {
          module.exports = (function (Point, Utils) {
            ...
            WaveformPoints.prototype._createPoint = function (options) {
              if (
                Object.prototype.hasOwnProperty.call(options, 'timestamp') ||
                !Object.prototype.hasOwnProperty.call(options, 'time')
              ) {
                this._peaks.options.deprecationLogger(
                  "peaks.points.add(): The 'timestamp' attribute is deprecated; use 'time' instead"
                );
                options.time = options.timestamp;
              }
              var point = new Point(
                this,
                Utils.isNullOrUndefined(options.id)
                  ? this._getNextPointId()
                  : options.id,
                options.time,
                options.labelText,
                options.color,
            ...
            WaveformPoints.prototype.add = function (pointOrPoints) {
              ...
              if (typeof points[0] === 'number') {
                this._peaks.options.deprecationLogger(
                  'peaks.points.add(): expected a segment object or an array'
                );
                points = [
                  {
                    time: arguments[0],
            ...
            _dereq_('peaks/markers/point'),
            _dereq_('peaks/waveform/waveform.utils')
          );
        },
        { 'peaks/markers/point': 73, 'peaks/waveform/waveform.utils': 92 },
      ],
      76: [
        function (_dereq_, module, exports) {
          module.exports = (function (Colors, Segment, Utils) {
            ...
            WaveformSegments.prototype._createSegment = function (options) {
              if (!Utils.isObject(options)) {
                throw new TypeError(
                  'peaks.segments.add(): expected a Segment object parameter'
                );
              }
              var segment = new Segment(
                this,
                Utils.isNullOrUndefined(options.id)
                  ? this._getNextSegmentId()
                  : options.id,
                options.startTime,
                options.endTime,
                options.labelText || '',
            ...
            WaveformSegments.prototype.add = function (segmentOrSegments) {
              ...
              if (typeof segments[0] === 'number') {
                this._peaks.options.deprecationLogger(
                  'peaks.segments.add(): expected a segment object or an array'
                );
                segments = [
                  {
            ...
            WaveformSegments.prototype.removeByTime = function (
              startTime,
              endTime
            ) {
            ...
            _dereq_('colors.css'),
            _dereq_('peaks/markers/segment'),
            _dereq_('peaks/waveform/waveform.utils')
          );
        },
        {
          'colors.css': 1,
          'peaks/markers/segment': 74,
          'peaks/waveform/waveform.utils': 92,
        },
      ],
      77: [
          ...
          module.exports = (function (Utils) {
            ...
            Player.prototype.playSegment = function (segment) {
              ...
              self._interval = setInterval(function () {
                if (
                  self.getCurrentTime() >= segment.endTime ||
                  self._mediaElement.paused
                ) {
                  clearTimeout(self._interval);
                  self._interval = null;
      ...
      78: [
        function (_dereq_, module, exports) {
          module.exports = (function () {
            ...
            KeyboardHandler.prototype._handleKeyEvent = function handleKeyEvent(
              event
            ) {
      ...
      80: [
        ...
        { konva: 43, 'peaks/waveform/waveform.utils': 92 },
      ],
      81: [
        function (_dereq_, module, exports) {
          module.exports = (function (Utils, Konva) {
            ...
            function PointsLayer(peaks, view, allowEditing, showLabels) {
              ...
              this._onPointHandleDblClick = this._onPointHandleDblClick.bind(
                this
              );
              this._onPointHandleDragStart = this._onPointHandleDragStart.bind(
                this
              );
              this._onPointHandleDragMove = this._onPointHandleDragMove.bind(
                this
              );
              this._onPointHandleDragEnd = this._onPointHandleDragEnd.bind(
                this
              );
              this._onPointHandleMouseEnter = this._onPointHandleMouseEnter.bind(
                this
              );
              this._onPointHandleMouseLeave = this._onPointHandleMouseLeave.bind(
                this
              );
            ...
            PointsLayer.prototype._createPointGroup = function (point) {
              ...
              pointGroup.marker = this._peaks.options.createPointMarker({
                ...
                handleColor: point.color
                  ? point.color
                  : this._peaks.options.pointMarkerColor,
            ...
            PointsLayer.prototype._updatePoint = function (point) {
              ...
              if (pointGroup.marker) {
                ...
                if (pointGroup.marker.time) {
                  pointGroup.marker.time.setText(
                    Utils.formatTime(point.time, false)
                  );
                }
              }
            };
            ...
            PointsLayer.prototype._removeInvisiblePoints = function (
              startTime,
              endTime
            ) {
              var count = 0;
        ...
        function (_dereq_, module, exports) {
          module.exports = (function (WaveformShape, Utils, Konva) {
            ...
            function SegmentsLayer(peaks, view, allowEditing) {
              ...
              this._onSegmentHandleDragStart = this._onSegmentHandleDragStart.bind(
                this
              );
              this._onSegmentHandleDragEnd = this._onSegmentHandleDragEnd.bind(
                this
              );
            ...
            SegmentsLayer.prototype._createSegmentGroup = function (segment) {
              ...
              segmentGroup.label = self._peaks.options.createSegmentLabel(
                segmentGroup,
                segment
              );
                ...
                segmentGroup.inMarker = this._peaks.options.createSegmentMarker(
                  {
                    ...
                    onDragStart: editable
                      ? self._onSegmentHandleDragStart
                      : null,
            ...
            SegmentsLayer.prototype._onSegmentHandleDrag = function (
              segmentGroup,
              segment,
              inMarker
            ) {
              ...
              if (inMarker) {
                ...
                if (inMarkerX > 0) {
                  var inOffset =
                    frameOffset + inMarkerX + segmentGroup.inMarker.getWidth();
            ...
            SegmentsLayer.prototype._onSegmentHandleDragStart = function (
              segment,
              inMarker
            ) {
              this._peaks.emit('segments.dragstart', segment, inMarker);
            };
            SegmentsLayer.prototype._onSegmentHandleDragEnd = function (
              segment,
              inMarker
            ) {
              this._peaks.emit('segments.dragend', segment, inMarker);
            };
            SegmentsLayer.prototype.updateSegments = function (
              startTime,
              endTime
            ) {
            ...
            SegmentsLayer.prototype._updateSegment = function (segment) {
              ...
              var segmentStartOffset = this._view.timeToPixels(
                segment.startTime
              );
              ...
              if (this._allowEditing && segment.editable) {
                ...
                if (marker) {
                  ...
                  marker.label.setText(
                    Utils.formatTime(segment.startTime, false)
                  );
                }
                ...
                if (marker) {
                  ...
                  marker.label.setText(
                    Utils.formatTime(segment.endTime, false)
                  );
                }
              }
            };
            SegmentsLayer.prototype._findOrAddSegmentGroup = function (
              segment
            ) {
              var segmentGroup = this._segmentGroups[segment.id];
              if (!segmentGroup) {
            ...
            SegmentsLayer.prototype._removeInvisibleSegments = function (
              startTime,
              endTime
            ) {
              var count = 0;
            ...
            _dereq_('peaks/views/waveform-shape'),
            _dereq_('peaks/waveform/waveform.utils'),
            _dereq_('konva')
          );
        },
      ...
      83: [
        function (_dereq_, module, exports) {
          module.exports = (function (
            ...
            _dereq_('peaks/views/waveform.overview'),
            _dereq_('peaks/views/waveform.zoomview'),
            _dereq_('peaks/waveform/waveform.utils')
          );
        },
        {
          'peaks/views/waveform.overview': 85,
          'peaks/views/waveform.zoomview': 88,
          'peaks/waveform/waveform.utils': 92,
        },
      ],
      84: [
        function (_dereq_, module, exports) {
          module.exports = (function (Utils, Konva) {
            ...
            function scaleY(amplitude, height, scale) {
              ...
              var offset = 128;
              var scaledAmplitude =
                ((amplitude * scale + offset) * height) / range;
            ...
            WaveformShape.prototype._drawWaveform = function (
              context,
              waveformData,
              frameOffset,
              startPixels,
            ...
            WaveformShape.prototype._drawChannel = function (
              context,
              channel,
              frameOffset,
              startPixels,
              ...
              for (x = startPixels; x < endPixels; x++) {
                ...
                context.lineTo(
                  x - frameOffset + 0.5,
                  top + scaleY(val, height, amplitudeScale) + 0.5
                );
              }
            ...
            WaveformShape.prototype._waveformShapeHitFunc = function (context) {
              ...
              var startPixels = this._view.timeToPixels(
      ...
      85: [
        function (_dereq_, module, exports) {
          module.exports = (function (
            ...
            function WaveformOverview(waveformData, container, peaks) {
              ...
              self._onZoomviewDisplaying = self._onZoomviewDisplaying.bind(
                this
              );
            ...
            WaveformOverview.prototype._onZoomviewDisplaying = function (
              startTime,
              endTime
            ) {
              this.showHighlight(startTime, endTime);
            };
            WaveformOverview.prototype.showHighlight = function (
              startTime,
              endTime
            ) {
            ...
            WaveformOverview.prototype.setWaveformData = function (
              waveformData
            ) {
            ...
            WaveformOverview.prototype.timeToPixels = function (time) {
              return Math.floor(
                (time * this._data.sample_rate) / this._data.scale
              );
            };
            ...
            WaveformOverview.prototype.setAmplitudeScale = function (scale) {
              if (!Utils.isNumber(scale) || !Number.isFinite(scale)) {
                throw new Error(
                  'view.setAmplitudeScale(): Scale must be a valid number'
                );
              }
            ...
            WaveformOverview.prototype._createHighlightRect = function (
              startTime,
              endTime
            ) {
            ...
            WaveformOverview.prototype._updateHighlightRect = function (
              startTime,
              endTime
            ) {
              this._highlightRectStartTime = startTime;
            ...
            _dereq_('peaks/views/playhead-layer'),
            _dereq_('peaks/views/points-layer'),
            _dereq_('peaks/views/segments-layer'),
            _dereq_('peaks/views/waveform-shape'),
            _dereq_('peaks/views/helpers/mousedraghandler'),
            _dereq_('peaks/waveform/waveform.axis'),
            _dereq_('peaks/waveform/waveform.utils'),
            _dereq_('konva')
          );
        },
        {
          konva: 43,
          'peaks/views/helpers/mousedraghandler': 79,
          'peaks/views/playhead-layer': 80,
          'peaks/views/points-layer': 81,
          'peaks/views/segments-layer': 82,
          'peaks/views/waveform-shape': 84,
          'peaks/waveform/waveform.axis': 90,
          'peaks/waveform/waveform.utils': 92,
        },
      ],
      86: [
        function (_dereq_, module, exports) {
          module.exports = (function () {
            ...
            TimeController.prototype.setCurrentTime = function (time) {
              this._peaks.options.deprecationLogger(
                'peaks.time.setCurrentTime(): this function is deprecated. Call peaks.player.seek() instead'
              );
              return this._peaks.player.seek(time);
            };
            TimeController.prototype.getCurrentTime = function () {
              this._peaks.options.deprecationLogger(
                'peaks.time.getCurrentTime(): this function is deprecated. Call peaks.player.getCurrentTime() instead'
              );
      ...
      87: [
        function (_dereq_, module, exports) {
          module.exports = (function () {
            ...
            ZoomController.prototype.setZoom = function (
              zoomLevelIndex,
              forceUpdate
            ) {
        ...
        function (_dereq_, module, exports) {
          module.exports = (function (
            ...
            function WaveformZoomView(waveformData, container, peaks) {
              ...
              self._onKeyboardShiftRight = self._onKeyboardShiftRight.bind(
                self
              );
              ...
              var initialZoomLevel =
                self._options.zoomLevels[peaks.zoom.getZoom()];
            ...
            WaveformZoomView.prototype._onZoomUpdate = function (
              currentScale,
              previousScale
            ) {
            ...
            WaveformZoomView.prototype._keyboardScroll = function (
              direction,
              large
            ) {
              var increment;
              if (large) {
                ...
                increment =
                  direction * this.timeToPixels(this._options.nudgeIncrement);
              }
              this._updateWaveform(this._frameOffset + increment);
            };
            WaveformZoomView.prototype.setWaveformData = function (
              waveformData
            ) {
              this._originalWaveformData = waveformData;
            };
            WaveformZoomView.prototype._syncPlayhead = function (time) {
              ...
              if (this._enableAutoScroll) {
                ...
                if (
                  pixelIndex >= endThreshold ||
                  pixelIndex < this._frameOffset
                ) {
            ...
            WaveformZoomView.prototype.setZoomLevel = function (
              currentScale,
              previousScale
            ) {
              ...
              if (
                playheadOffsetPixels >= 0 &&
                playheadOffsetPixels < this._width
              ) {
                apexTime = currentTime;
              } else {
                playheadOffsetPixels = this._width / 2;
                apexTime = this.pixelsToTime(
                  this._frameOffset + playheadOffsetPixels
                );
              }
            ...
            WaveformZoomView.prototype._updateWaveform = function (
              frameOffset
            ) {
              var upperLimit;
              ...
              this._playheadLayer.updatePlayheadTime(
                this.pixelsToTime(playheadPixel)
              );
              this._waveformLayer.draw();
              this._axisLayer.draw();
              var frameStartTime = this.pixelsToTime(this._frameOffset);
              var frameEndTime = this.pixelsToTime(
                this._frameOffset + this._width
              );
              this._pointsLayer.updatePoints(frameStartTime, frameEndTime);
              this._segmentsLayer.updateSegments(frameStartTime, frameEndTime);
              this._peaks.emit(
        ...
        function (_dereq_, module, exports) {
          module.exports = (function (WaveformData, Utils) {
            ...
            WaveformBuilder.prototype.init = function (options, callback) {
              if (
                options.dataUri &&
                (options.webAudio || options.audioContext)
              ) {
                throw new Error(
                  'Peaks.init(): You must pass a webAudio or dataUri to render waveform data, not both'
                );
              }
              ...
              if (options.dataUri) {
                ...
                if (options.webAudio.audioBuffer) {
                  return this._buildWaveformDataFromAudioBuffer(
                    options,
                    callback
                  );
                } else {
                  return this._buildWaveformDataUsingWebAudio(
                    options,
                    callback
                  );
                }
                ...
                throw new Error(
                  'Peaks.init(): You must pass an audioContext or dataUri to render waveform data'
                );
              }
            };
            WaveformBuilder.prototype._getRemoteWaveformData = function (
              ...
              if (Utils.isObject(options.dataUri)) {
                ...
                dataUri = {};
                dataUri[options.dataUriDefaultFormat || 'json'] =
                  options.dataUri;
              } else {
                throw new Error(
                  'Peaks.init(): The dataUri option must be an object'
                );
              }
              ...
              var xhr = self._createXHR(
                ...
                function (event) {
                  ...
                  if (this.status !== 200) {
                    callback(
                      new Error(
                        'Unable to fetch remote data. HTTP status ' +
                          this.status
                      )
                    );
                    return;
            ...
            WaveformBuilder.prototype._buildWaveformDataFromAudioBuffer = function (
              options,
              callback
            ) {
              var webAudioOptions = options.webAudio;
            ...
            WaveformBuilder.prototype._requestAudioAndBuildWaveformData = function (
              ...
              if (!url) {
                self._peaks.logger(
                  'Peaks.init(): The mediaElement src is invalid'
                );
                return;
              }
              var xhr = self._createXHR(
            ...
            WaveformBuilder.prototype._createXHR = function (
              url,
              requestType,
              withCredentials,
              onLoad,
            ...
            _dereq_('waveform-data'),
            _dereq_('peaks/waveform/waveform.utils')
          );
        },
        { 'peaks/waveform/waveform.utils': 92, 'waveform-data': 69 },
      ],
      90: [
        function (_dereq_, module, exports) {
          module.exports = (function (Utils, Konva) {
            ...
            WaveformAxis.prototype.drawAxis = function (context, view) {
              var currentFrameStartTime = view.pixelsToTime(
                view.getFrameOffset()
              );
              var markerHeight = 10;
              var axisLabelIntervalSecs = this.getAxisLabelScale(view);
              var firstAxisLabelSecs = Utils.roundUpToNearest(
                currentFrameStartTime,
                axisLabelIntervalSecs
              );
              var axisLabelOffsetSecs =
                firstAxisLabelSecs - currentFrameStartTime;
              var axisLabelOffsetPixels = view.timeToPixels(
                axisLabelOffsetSecs
              );
              ...
              for (;;) {
                x =
                  axisLabelOffsetPixels +
                  view.timeToPixels(secs - firstAxisLabelSecs);
                if (x >= width) {
                  break;
                }
                context.beginPath();
            ...
            function createSegmentMarker(options) {
              ...
              var group = new Konva.Group({
                ...
                dragBoundFunc: function (pos) {
                  ...
                  if (options.inMarker) {
                    limit =
                      options.segmentGroup.outMarker.getX() -
                      options.segmentGroup.outMarker.getWidth();
                    if (pos.x > limit) {
                      pos.x = limit;
                    }
                  } else {
                    limit =
                      options.segmentGroup.inMarker.getX() +
                      options.segmentGroup.inMarker.getWidth();
                    if (pos.x < limit) {
                      pos.x = limit;
                    }
                  }
      ...
      92: [
        function (_dereq_, module, exports) {
          module.exports = (function () {
            ...
            return {
              formatTime: function (time, dropThousandths) {
                var result = [];
                var thousandths = Math.floor((time % 1) * 1000);
              ...
              roundUpToNearest: function (value, multiple) {
                ...
                return (
                  multiplier *
                  (((roundedUp + multiple - 1) / multiple) | 0) *
                  multiple
                );
              },
